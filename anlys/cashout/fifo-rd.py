...
for row in df: # name and ticker pairs
    ...
    # if set([trnsc[3] for trnsc in trnscs]) == {"Purchase"}:
    #     continue
    # if len(trnscs) == 0:
    #     continue
    # if len(trnscs) == 1: # like sale only
    #     continue
    # if "Purchase" not in set([trnsc[3] for trnsc in trnscs]): # nothing to match cuz all are sales
    #     continue
